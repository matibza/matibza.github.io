...
function borrar_feriados() {
	for (var iff = 2; iff < 505;) {
		var xx = 'a' + iff;
		document.getElementById(xx).style.backgroundColor = 'gray';
		iff++;
	}
}
function dia_actual() {
	...
	var añocalend = document.getElementById('tit').innerHTML;
	if (año == añocalend) {
		if (mes == 0) {
			for (var i = 2; i <= 43;) {
				var rr = 'a' + i;
				var rr2 = document.getElementById(rr).innerHTML;
				if (rr2 == dia) {
				document.getElementById(rr).style.backgroundColor = 'blue';
				document.getElementById(rr).style.fontSize = '20px';
		...
		if (mes == 1) {
			...
			document.getElementById('ancla_febrero').click();
		}
		if (mes == 2) {
			for (var i = 86; i <= 127;) {
				var rr = 'a' + i;
			...
			document.getElementById('ancla_marzo').click();
		}
		if (mes == 3) {
			for (var i = 128; i <= 169;) {
				var rr = 'a' + i;
			...
			document.getElementById('ancla_abril').click();
		}
		if (mes == 4) {
			for (var i = 170; i <= 211;) {
				var rr = 'a' + i;
			...
			document.getElementById('ancla_mayo').click();
		}
		if (mes == 5) {
			for (var i = 212; i <= 253;) {
				var rr = 'a' + i;
			...
			document.getElementById('ancla_junio').click();
		}
		if (mes == 6) {
			for (var i = 254; i <= 295;) {
				var rr = 'a' + i;
			...
			document.getElementById('ancla_julio').click();
		}
		if (mes == 7) {
			for (var i = 296; i <= 337;) {
				var rr = 'a' + i;
			...
			document.getElementById('ancla_agosto').click();
		}
		if (mes == 8) {
			for (var i = 338; i <= 379;) {
				var rr = 'a' + i;
			...
			document.getElementById('ancla_septiembre').click();
		}
		if (mes == 9) {
			for (var i = 380; i <= 421;) {
				var rr = 'a' + i;
			...
			document.getElementById('ancla_octubre').click();
		}
		if (mes == 10) {
			for (var i = 422; i <= 463;) {
				var rr = 'a' + i;
			...
			document.getElementById('ancla_noviembre').click();
		}
		if (mes == 11) {
			for (var i = 464; i <= 505;) {
				var rr = 'a' + i;
			...
			document.getElementById('ancla_diciembre').click();
		}
	}
}
